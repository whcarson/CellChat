...
```{r}
LCMA01_BEVR_CD31_Mat <- ReadMtx(mtx = "../Aghi Lab/CD31 sorted/LCMA01_BEVR_CD31/filtered_feature_bc_matrix/matrix.mtx.gz", features = "../Aghi Lab/CD31 sorted/LCMA01_BEVR_CD31/filtered_feature_bc_matrix/features.tsv.gz", cells = "../Aghi Lab/CD31 sorted/LCMA01_BEVR_CD31/filtered_feature_bc_matrix/barcodes.tsv.gz")

LCMA01_BEVR_CD31 <- CreateSeuratObject(counts = LCMA01_BEVR_CD31_Mat)

```

Create Clusters Using Seurat
```{r}
...
LCMA01_BEVR_CD31 <- ScaleData(LCMA01_BEVR_CD31, features = all.genes)

LCMA01_BEVR_CD31 <- RunPCA(LCMA01_BEVR_CD31,  features=VariableFeatures(object=LCMA01_BEVR_CD31))
print(LCMA01_BEVR_CD31[["pca"]], dims=1:5, nfeatures = 5)
```

Create a cell chat
```{r}
LCMA01_BEVR_CD31_Chat <- createCellChat(object = LCMA01_BEVR_CD31, group.by="labels")
```
