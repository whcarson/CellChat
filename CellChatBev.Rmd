...
for (i in 1:length(seurats)){
  ...
  seurats[[i]]$seurat_clusters <- as.factor(as.numeric(as.character(seurats[[i]]$seurat_clusters)) + 1)
...
Compute Probability that Two Cell Classes Communicate Through Given Pathway
...
# for (i in 1:length(chats)){
#   chats[[i]] <- computeNetSimilarity(chats[[i]], type = "functional")
#   chats[[i]] <- netClustering(chats[[i]], type = "functional")
# }
# 
# # Visualization in 2D-space
# netVisual_embedding(chats[[i]], type = "functional", label.size = 3.5)
# # netVisual_embeddingZoomIn(chats[[i]], type = "functional", nCol = 2)
```
