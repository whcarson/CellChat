...
Merge CellChats
```{r}
BEVR_Merged <- mergeCellChat(c(chats[[1]], chats[[3]]), add.names = c(chat_names[[1]], chat_names[[3]]), cell.prefix=TRUE)
GBM_Merged <- mergeCellChat(c(chats[[2]], chats[[4]]), add.names = c(chat_names[[2]], chat_names[[4]]), cell.prefix=TRUE)
CD31_Merged <- mergeCellChat(c(chats[[1]], chats[[2]]), add.names = c(chat_names[[1]], chat_names[[2]]), cell.prefix=TRUE)
Unsorted_Merged <- mergeCellChat(c(chats[[3]], chats[[4]]), add.names = c(chat_names[[3]], chat_names[[4]]), cell.prefix=TRUE)
